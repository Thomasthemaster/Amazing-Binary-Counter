...
## 🚀 How It Works
The sketch utilizes three primary pins (Latch, Clock, and Data) to shift an 8-bit byte out to the register. The byte automatically increments (`LEDs++`) on every cycle, visualizing a binary count from `00000000` to `11111111` with LEDs.
...
## 📊 Schematic
Below is the wiring schematic used to hook up the circuit:

![Project Wiring Diagram](YOUR_SCHEMATIC_FILENAME.png)
